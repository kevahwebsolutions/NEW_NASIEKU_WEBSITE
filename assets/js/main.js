...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupMobileMenu() {
        ...
        const menuItems = document.querySelectorAll('.categories_menu_toggle .menu_item_children');
        
        menuItems.forEach(item => {
            const link = item.querySelector('a');
            const submenu = item.querySelector('.categories_mega_menu, .categorie_sub_menu');
    ...
    function handleMobileClick(e) {
        ...
        if (submenu) {
            console.log('Toggling submenu for:', this.textContent.trim()); // Debug log
            
            // Toggle current submenu
            const isOpen = submenu.classList.contains('mobile-active');
            ...
            if (isOpen) {
                ...
                siblings.forEach(sibling => {
                    if (sibling !== item && sibling.classList.contains('menu_item_children')) {
                        const siblingSubmenu = sibling.querySelector('.categories_mega_menu, .categorie_sub_menu');
                        if (siblingSubmenu) {
                            siblingSubmenu.classList.remove('mobile-active');
